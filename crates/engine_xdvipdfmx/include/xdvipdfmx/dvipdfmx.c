...
const tt_xdvipdfmx_config_t* dpx_config;
...
int
tt_engine_xdvipdfmx_main(ttbc_state_t *api, const tt_xdvipdfmx_config_t* config, const char *dviname, const char *pdfname, bool compress, bool deterministic_tags, time_t build_date)
{
    int rv;
